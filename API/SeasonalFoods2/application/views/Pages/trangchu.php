    ...
    <div class="product-heading text-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-8 col-6 offset-sm-2 offset-md-0 product-item">
    ...
    <div class="product-heading text-center">
        ...
        <div class="container">
            <div class="row">
                ...
                ?>
                <div class="col-md-3 col-sm-8 col-6 offset-sm-2 offset-md-0 product-item product-new-item">
